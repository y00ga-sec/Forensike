...
- `Metadate` : Uses rcedit-x64.exe to tamper with DumpIt.exe metadate. Helps if you need bypass detection rules based on filename or description AND if the EDR let's you load new executable broken signature 
